...
namespace StopEC2
{
    public class Function
    {
        ...
        {
            string instanceToShutDownid = message.Body;
            // list of instances -- maybe heavy operation to fetch.

            await _eC2Service.StopInstanceAsync(instanceToShutDownid);
            await _sQSService.SendMessageAsync(startModificationQueueUrl, instanceToShutDownid);
            // ack / delete?
        }
    }
}