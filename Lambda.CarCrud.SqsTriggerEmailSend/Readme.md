...
Execute unit tests
```
    cd "Lambda.CarCrud.SqsTriggerEmailSend/test/Lambda.CarCrud.SqsTriggerEmailSend.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Lambda.CarCrud.SqsTriggerEmailSend/src/Lambda.CarCrud.SqsTriggerEmailSend"
